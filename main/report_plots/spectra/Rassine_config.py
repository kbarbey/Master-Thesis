...
spectrum_name = cwd+"/zetgem_07.csv"
...
mask_telluric = [[5885,5900],[6275,6330],   # a list of left and right borders to eliminate from the mask of the CCF
...
interpolation = 'linear' # define the interpolation for the continuum displayed in the subproducts            
